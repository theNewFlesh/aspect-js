<template>
  <v-layout row>
    ...
    <v-flex justify-end class="aspect-spinbox-button-up">
      <v-btn @click="on_increment_value" depressed small color="aspect_cyan_1">
        <i class="material-icons aspect-up-arrow-icon">arrow_upward</i>
      </v-btn>
    </v-flex>
    <v-flex justify-end class="aspect-spinbox-button-down">
      <v-btn @click="on_decrement_value" depressed small color="aspect_cyan_1">
...
.aspect-up-arrow-icon, .aspect-down-arrow-icon {
  color: aspect_grey_1;
  font-size: 20px;
}
